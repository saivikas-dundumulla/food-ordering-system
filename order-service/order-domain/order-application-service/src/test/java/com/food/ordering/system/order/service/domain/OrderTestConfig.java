...
// we add this to start spring context and load all the beans in the order domain package,
// so we can autowire them in our tests
...
public class OrderTestConfig {
    ...
    @Bean
    public OrderDomainService orderDomainService() { // need to configure this because coming from domain no @annotation
